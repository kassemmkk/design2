            ...
            if (bus_we) begin
                ...
                case (bus_addr)
                    ...
                    REG_OUTPUT_DATA: begin
                        ...
                        if ({8'h00, output_ptr} < output_len_reg) begin
                ...
                STATE_RECEIVE: begin
                    ...
                    if (ext_ack) begin
                        ...
                        if (output_len_reg < 252) begin
                            output_buffer[output_len_reg[7:0]] <= ext_result[7:0];
                            output_buffer[output_len_reg[7:0]+1] <= ext_result[15:8];
                            output_buffer[output_len_reg[7:0]+2] <= ext_result[23:16];
                            output_buffer[output_len_reg[7:0]+3] <= ext_result[31:24];
                            output_len_reg <= output_len_reg + 4;
                        end
                        
                        trans_counter <= trans_counter + 4;
                        if ({8'h00, trans_counter} >= input_len_reg) begin
