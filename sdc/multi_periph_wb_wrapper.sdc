...
###############################################################################
current_design multi_periph_wb_wrapper
###############################################################################
# Timing Constraints
###############################################################################
...
set_input_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {gpio_in[0]}]
set_input_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {gpio_in[1]}]
set_input_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {i2c_scl_i}]
set_input_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {i2c_sda_i}]
set_input_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {spi0_miso}]
set_input_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {spi1_miso}]
...
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {gpio_oe[0]}]
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {gpio_oe[1]}]
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {gpio_out[0]}]
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {gpio_out[1]}]
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {i2c_scl_o}]
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {i2c_scl_oen_o}]
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {i2c_sda_o}]
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {i2c_sda_oen_o}]
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {spi0_csb}]
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {spi0_mosi}]
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {spi0_sclk}]
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {spi1_csb}]
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {spi1_mosi}]
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {spi1_sclk}]
...
set_load -pin_load 0.0334 [get_ports {i2c_scl_oen_o}]
set_load -pin_load 0.0334 [get_ports {i2c_sda_o}]
set_load -pin_load 0.0334 [get_ports {i2c_sda_oen_o}]
set_load -pin_load 0.0334 [get_ports {spi0_csb}]
set_load -pin_load 0.0334 [get_ports {spi0_mosi}]
set_load -pin_load 0.0334 [get_ports {spi0_sclk}]
set_load -pin_load 0.0334 [get_ports {spi1_csb}]
set_load -pin_load 0.0334 [get_ports {spi1_mosi}]
set_load -pin_load 0.0334 [get_ports {spi1_sclk}]
...
set_driving_cell -lib_cell sky130_fd_sc_hd__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {spi0_miso}]
set_driving_cell -lib_cell sky130_fd_sc_hd__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {spi1_miso}]
